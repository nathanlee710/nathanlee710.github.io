...
async function tagSetterCivil () {
    ...
    .contains('officialsAskedNew', "Policymaker")
    .distinct('officialsAskedNew')//this says the values
    .then((results) => {
		console.log(results.length)
        if(results.length===1){
			return makePositions(String("Policymaker"));
        }if(results.length===2){
            return makePositions(String("Policymaker")),makePositions(String("Civil Servant"));
        }else{return makePositions(String("Civil Servant"))}
